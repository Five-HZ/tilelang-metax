...
def test_fp8_vectorized_min_max(op):
    ...
    tilelang.compile(fp8_operand_vectorized_kernel(1024, 128, T.float8_e4m3, op), out_idx=[2], target="auto")
...
def test_fp8_e4m3fn_min_max():
    ...
    # both min and max.
    tilelang.compile(fp8_operand_kernel(1024, 128, T.float8_e4m3fn, "clamp"), out_idx=[2], target="auto")
